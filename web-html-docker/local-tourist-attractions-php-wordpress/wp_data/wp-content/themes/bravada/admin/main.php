...
add_action( 'after_setup_theme', 'bravada_admin_init', 2 );
...
<div class="wrap" id="main-page"><!-- Admin wrap page -->
	...
	<div id="righty">
		<div id="cryout-donate" class="postbox donate">
			...
			<div class="inside">
				<p><?php printf( __('Find out what features you\'re missing out on and how the Plus version of %1$s can improve your site.', 'bravada'), cryout_sanitize_tnl( _CRYOUT_THEME_NAME ) )  ?></p>
